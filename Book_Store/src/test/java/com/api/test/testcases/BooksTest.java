package com.api.test.testcases;

import com.api.test.base.BaseSetup;
import com.api.test.constants.ApiEndPointsInfo;
...
public class BooksTest extends BaseSetup {
    ...
    public void addBooksTest() {
        Response response = given()
                ...
                .body(jsonPayload)
                .when()
                .post(ApiEndPointsInfo.ADD_NEW_BOOK)
    ...
    public void getBookByIdTest() {
        Response response = given()
                ...
                .log().all() // Log the request details
                .when()
                .get(String.format(ApiEndPointsInfo.GET_BOOK_ID, bookId))
                .then()
    ...
    public void updateBookByIdTest() {
        ...
        Response response = given()
                ...
                .log().all() // Log the request details
                .when()
                .put(String.format(ApiEndPointsInfo.GET_BOOK_ID, bookId))
                .then()
                .log().all() // Log the response details
                .statusCode(200)
                .extract().response();
    ...
    public void getAllBooks() {
        Response response = given()
                ...
                .log().all() // Log the request details
                .when()
                .get(ApiEndPointsInfo.GET_ALL_BOOKS)
                .then()
                .log().all() // Log the response details
                .statusCode(200)
                .extract().response();
    ...
    public void deleteBookByIdTest() {
        Response response = given()
                ...
                .log().all() // Log the request details
                .when()
                .delete(String.format(ApiEndPointsInfo.GET_BOOK_ID, bookId))
                .then()
                .log().all() // Log the response details
                .statusCode(200)
                .extract().response();
